...
class UsuariosTest < ApplicationSystemTestCase
  ...
  test "should create usuario" do
    ...
    check "Habilitado" if @usuario.habilitado
    fill_in "Nacimiento", with: @usuario.nacimiento
    fill_in "Nombre", with: @usuario.nombre
    fill_in "Primerapellido", with: @usuario.primerapellido
    fill_in "Segundoapellido", with: @usuario.segundoapellido
